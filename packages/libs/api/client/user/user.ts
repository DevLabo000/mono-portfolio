...
import type { LoginUserParams, User } from '.././types';
 ...
 * @summary Create user
 */
export const createUser = (user: User, options?: AxiosRequestConfig): Promise<AxiosResponse<User>> => {
  return axios.post(`/user`, user, options);
};

export const getCreateUserMutationOptions = <TError = AxiosError<User>, TContext = unknown>(options?: {
 ...
 */
export const createUsersWithListInput = (user: User[], options?: AxiosRequestConfig): Promise<AxiosResponse<User>> => {
  return axios.post(`/user/createWithList`, user, options);
};

export const getCreateUsersWithListInputMutationOptions = <TError = AxiosError<void>, TContext = unknown>(options?: {
  ...
  const mutationFn: MutationFunction<Awaited<ReturnType<typeof createUsersWithListInput>>, { data: User[] }> = (
    props,
  ) => {
    const { data } = props ?? {};
...
export const getLoginUserQueryOptions = <TData = Awaited<ReturnType<typeof loginUser>>, TError = AxiosError<void>>(
...
export const getUpdateUserMutationOptions = <TError = AxiosError<void>, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
